...
pub struct App {
    ...
    bp_cond_buffer: std::collections::HashMap<u32, String>,
}
                            ...
                            .show(ui, |ui| {
                                ...
                                if self.open_bp {
                                    ...
                                    egui::Grid::new("bp_grid")
                                        ...
                                        .show(ui, |ui| {
                                            ...
                                            for bp in &self.state.persistent.breakpoints {
                                                ...
                                                if should_commit_breakpoint_condition(
                                                    resp.lost_focus(),
                                                    buffer,
                                                    &bp.condition,
                                                ) {
                                                ...
                                                if bp.condition_error.is_some() {
                                                    ui.label(m("⚠", 12.0, RED)).on_hover_text(
                                                        bp.condition_error.as_deref().unwrap_or(""),
                                                    );
                                                } else {
                                                    ui.label("");
                                                }
                                    ...
                                    for (id, condition) in pending_commits {
                                        self.send(Command::SetBreakpointCondition {
                                            id,
                                            condition,
                                        });
                                    }
...
fn should_commit_breakpoint_condition(
    lost_focus: bool,
    buffer_text: &str,
